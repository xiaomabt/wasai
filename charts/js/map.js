...
$(function () {
   ...
   //===================================//
    ...
    //==================================================
    //地图
    var myChart = echarts.init(document.getElementById('james'));
    option = {
        title: {
    ...
    var myChart2 = echarts.init(document.getElementById('james_1'));
    option2 = {
        tooltip: {
            trigger: 'item',
            formatter: '{b}'
    ...
    var Chart = echarts.init(document.getElementById('james_3'));
    option3 = {
        tooltip: {
            trigger: 'item',
            formatter: '{b}'
    ...
    var Chart1 = echarts.init(document.getElementById('james_4'));
    option4 = {
        tooltip: {
            trigger: 'item',
            formatter: '{b}'
