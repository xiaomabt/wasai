...
$(function () {
    ...
    //mpfr
    $('#two ul li').mouseenter(function () {
        //$("#two ul li").stop(true,true);
        $(this).find('.mpfr_').animate({'height':'130px'},'normal');
        $(this).find('.mmm').css({display:'block'})
    })
    $('#two ul li').mouseleave(function () {
        //$("#two ul li").stop(true,true);
        $(this).find('.mpfr_').animate({'height':'4px'},'fast',function () {
            $(this).find('.mmm').css({display:'none'})
        });
    })
})
