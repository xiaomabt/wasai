...
$(function () {
    ...
    //轮播图
    var mySwiper_1 = new Swiper ('#nav_1 .swiper-container', {
        direction: 'horizontal',
        loop: true,

        // 如果需要分页器
        pagination: '#nav_1 .swiper-pagination',
    ...
    //轮播图
    var mySwiper_2 = new Swiper ('.box3_2 .swiper-container', {
        direction: 'vertical',
        loop: true,

        // 如果需要分页器
        pagination: '.box3_2 .swiper-pagination',
